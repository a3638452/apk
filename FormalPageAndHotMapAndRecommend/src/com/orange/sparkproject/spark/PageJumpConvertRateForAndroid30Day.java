...
private static JavaRDD<Row> generateRDD(SparkSession spark) {
	 JavaRDD<String> pageRDD = spark.sparkContext().textFile(Constants.HDFS_URL_ANDROID_30D,
				3).toJavaRDD();
...
PageSplitConvertRate pageSplitConvertRate2 = new PageSplitConvertRate();
	...
	//执行插入方法
	AndroidPageSplitConvertRateDAO pageSplitConvertRateDAO = DAOFactory.getAndroidPageSplitConvertRateDAO30Day();
